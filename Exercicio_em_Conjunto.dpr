...
begin
  ...
  begin
    ...
    begin
      Writeln('Obrigatório ter mais de 5 caracteres, digite novamente...');
      Sleep(1000);
    end;
  end;

  // Gerar a senha temporária com 8 caracteres
  senha := GerarSenhaTemporaria(8);

  Writeln('Sua senha temporária é: ', senha);
  Writeln('Use essa senha para fazer o primeiro login e depois altere sua senha.');

  // Aqui você pode salvar o nome, número, usuário e senha em sua estrutura de dados
end;
